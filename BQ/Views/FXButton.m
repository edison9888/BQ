...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.titleLabel.adjustsFontSizeToFitWidth && self.titleLabel.numberOfLines == 1)
    {
        textRect.size = [self.titleLabel.text sizeWithFont:self.titleLabel.font
                                    minFontSize:self.titleLabel.minimumScaleFactor
    ...
    //set color
    UIColor *highlightedColor = self.titleLabel.highlightedTextColor ?: self.titleLabel.textColor;
    UIColor *textColor = self.highlighted? highlightedColor: self.titleLabel.textColor;
    ...
    BOOL hasShadow = self.titleLabel.shadowColor &&
    ![self.titleLabel.shadowColor isEqual:[UIColor clearColor]] &&
    (shadowBlur > 0.0f || !CGSizeEqualToSize(self.titleLabel.shadowOffset, CGSizeZero));
    ...
    if (needsMask)
    {
        ...
        [self.titleLabel.text drawInRect:textRect withFont:font lineBreakMode:self.titleLabel.lineBreakMode alignment:self.titleLabel.textAlignment];
    ...
    if (hasShadow)
    {
        ...
        CGContextSetShadowWithColor(context, self.titleLabel.shadowOffset, shadowBlur, self.titleLabel.shadowColor.CGColor);
        [needsMask? [self.titleLabel.shadowColor colorWithAlphaComponent:textAlpha]: textColor setFill];
        [self.titleLabel.text drawInRect:textRect withFont:font lineBreakMode:self.titleLabel.lineBreakMode alignment:self.titleLabel.textAlignment];
        CGContextRestoreGState(context);
    }
    else if (!needsMask)
